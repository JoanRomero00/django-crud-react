        ...
        <nav className="bg-gray-800">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <Link to="/tasks" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Task App
                                </Link>
                                <Link to="/tasks-create" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                                    Create Task
                                </Link>
                            </div>
                        </div>
            ...
            <div className="sm:hidden" id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    <Link to="/tasks" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                        Task App
                    </Link>
                    <Link to="/tasks-create" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
                        Create Task
                    </Link>
                </div>
            </div>
